...
// Need to be long in order to hold typical values ...
  ...
  public Lcg(long a_value, long c_value, long m_value, long s_value) {
  ...
  // Since Rng doesn't know about the instance variables defined in this
  // particular implementation, Lcg, we need to type-cast
